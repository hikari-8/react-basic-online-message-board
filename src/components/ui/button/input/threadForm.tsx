...
export const ThreadForm:React.FC<InputAreaProps> =({buttonName, onSubmitFunc, onChangeFunc})=> {
  return (
    <div>
      <form className="w-1/2 mx-auto" onSubmit={onSubmitFunc}>   
          <div className="relative">
              <input onChange={onChangeFunc} type="search" id="default-search" className="p-4 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Please input title for new thread" required />
